...
import { LayoutDashboard, FileText, PenSquare, Mail, BarChart2, LogOut, Menu, X, Loader2, LayoutTemplate } from 'lucide-react';
...
const sidebarLinks = [
  ...
  { label: 'Editor do Site', href: '/admin/site', icon: LayoutTemplate },
